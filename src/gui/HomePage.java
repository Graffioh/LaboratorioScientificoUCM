...
public class HomePage extends JPanel {
	...
	public HomePage() {
		...
		strumentiTable.setRowSelectionAllowed(false);
		strumentiTable.setFocusable(false);
		...
		dotazioniTable.setRowSelectionAllowed(false);
		dotazioniTable.setFocusable(false);
